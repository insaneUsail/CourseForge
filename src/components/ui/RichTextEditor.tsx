  ...
  return (
    <div className="flex flex-wrap items-center gap-2 p-3 bg-[#F5F3FF] border-b-2 md:border-b-4 border-black rounded-t-xl shrink-0">
      <button
        ...
        className={clsx('p-2 rounded-lg transition-all border-2 font-black', editor.isActive('bold') ? 'bg-[#18102B] text-[#C6FF3D] border-black shadow-[2px_2px_0px_rgba(198,255,61,1)]' : 'bg-white text-[#18102B] border-black shadow-[2px_2px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:bg-[#C6FF3D]')}
        title="Bold"
      >
      ...
      <button
        ...
        className={clsx('p-2 rounded-lg transition-all border-2 font-black', editor.isActive('heading', { level: 1 }) ? 'bg-[#18102B] text-[#C6FF3D] border-black shadow-[2px_2px_0px_rgba(198,255,61,1)]' : 'bg-white text-[#18102B] border-black shadow-[2px_2px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:bg-[#C6FF3D]')}
        title="Heading 1"
      >
      ...
      <button
        ...
        className={clsx('p-2 rounded-lg transition-all border-2 font-black', editor.isActive('heading', { level: 2 }) ? 'bg-[#18102B] text-[#C6FF3D] border-black shadow-[2px_2px_0px_rgba(198,255,61,1)]' : 'bg-white text-[#18102B] border-black shadow-[2px_2px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:bg-[#C6FF3D]')}
        title="Heading 2"
      >
      ...
      <button
        ...
        className={clsx('p-2 rounded-lg transition-all border-2 font-black', editor.isActive('bulletList') ? 'bg-[#18102B] text-[#C6FF3D] border-black shadow-[2px_2px_0px_rgba(198,255,61,1)]' : 'bg-white text-[#18102B] border-black shadow-[2px_2px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:bg-[#C6FF3D]')}
        title="Bullet List"
      >
      ...
      <button
        ...
        className={clsx('p-2 rounded-lg transition-all border-2 font-black', editor.isActive('orderedList') ? 'bg-[#18102B] text-[#C6FF3D] border-black shadow-[2px_2px_0px_rgba(198,255,61,1)]' : 'bg-white text-[#18102B] border-black shadow-[2px_2px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:bg-[#C6FF3D]')}
        title="Numbered List"
      >
      ...
      <button
        ...
        className={clsx('p-2 rounded-lg transition-all border-2 font-black', editor.isActive('blockquote') ? 'bg-[#18102B] text-[#C6FF3D] border-black shadow-[2px_2px_0px_rgba(198,255,61,1)]' : 'bg-white text-[#18102B] border-black shadow-[2px_2px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] hover:bg-[#C6FF3D]')}
        title="Quote"
      >
...
export function RichTextEditor({ value, onChange, placeholder = 'Start writing...', className }: RichTextEditorProps) {
  ...
  return (
    <div className={clsx('border-2 md:border-4 border-black rounded-2xl bg-white shadow-[4px_4px_0px_rgba(0,0,0,1)] md:shadow-[8px_8px_0px_rgba(0,0,0,1)] focus-within:ring-4 focus-within:ring-[#C6FF3D] transition-all flex flex-col overflow-hidden', className)}>
