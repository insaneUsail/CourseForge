    ...
    <div className="flex w-full h-full bg-white relative">
      ...
      <div className="flex-1 w-full p-4 md:p-6 lg:p-8 z-10">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="mb-6 md:mb-12 bg-[#FF6B35] p-4 md:p-6 lg:p-8 rounded-[32px] border-2 md:border-4 border-black shadow-[4px_4px_0px_rgba(0,0,0,1)] md:shadow-[8px_8px_0px_rgba(0,0,0,1)] relative overflow-hidden">
