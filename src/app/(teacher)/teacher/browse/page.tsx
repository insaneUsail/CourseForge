...
export default async function BrowsePage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 lg:p-8">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-6 mb-6 md:mb-12 pb-6 border-b-2 md:border-b-4 border-black">
        <div className="w-20 h-20 bg-[#60A5FA] border-2 md:border-4 border-black shadow-[4px_4px_0px_rgba(0,0,0,1)] rounded-2xl flex items-center justify-center flex-shrink-0 -rotate-3">
