    ...
    <div className="flex w-full h-[calc(100vh-64px)] bg-white relative">
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-12 z-10">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="mb-6 md:mb-12 bg-[#834DFB] p-4 md:p-8 rounded-[32px] border-2 md:border-4 border-black shadow-[4px_4px_0px_rgba(0,0,0,1)] md:shadow-[8px_8px_0px_rgba(0,0,0,1)] relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h1 className="text-lg md:text-2xl md:text-4xl md:text-5xl font-black text-white mb-4 uppercase tracking-tighter w-full max-w-3xl truncate" style={{ WebkitTextStroke: '1px black' }}>
                {classData.name}
              </h1>
