  ...
  return (
    <div className="page-enter flex-1 flex flex-col min-h-screen bg-[#F5F3FF] overflow-hidden relative">
      ...
      <motion.div 
        ...
        className="absolute top-20 left-10 w-24 h-24 bg-[#B4F481] border-4 border-[#18102B] rounded-full opacity-80 shadow-[8px_8px_0px_#18102B] pointer-events-none z-0"
      />
      <motion.div 
        animate={{ y: [0, 30, 0], rotate: [12, -5, 12] }}
        transition={{ repeat: Infinity, duration: 10, ease: "easeInOut" }}
        className="absolute bottom-20 right-10 w-32 h-32 bg-[#2563EB] border-4 border-[#18102B] opacity-80 rotate-12 shadow-[8px_8px_0px_#18102B] pointer-events-none z-0"
      />
      <motion.div 
        animate={{ x: [0, 20, 0], rotate: [45, 90, 45] }}
        transition={{ repeat: Infinity, duration: 12, ease: "easeInOut" }}
        className="absolute top-40 right-40 w-16 h-16 bg-[#F0E100] border-4 border-[#18102B] opacity-80 rotate-45 shadow-[4px_4px_0px_#18102B] pointer-events-none z-0"
      />
      ...
      <main className="flex-1 flex flex-col md:flex-row max-w-7xl mx-auto w-full z-10 relative">
        ...
        >
          <div className="w-20 h-20 bg-[#18102B] border-4 border-black rounded-2xl flex items-center justify-center mb-8 shadow-[6px_6px_0px_rgba(0,0,0,1)] -rotate-3">
        ...
        >
          <TiltWrapper className="w-full max-w-md bg-white p-10 rounded-[32px] border-4 border-black shadow-[12px_12px_0px_rgba(0,0,0,1)] relative z-20">
            ...
            <div className="mb-10 text-center">
              <h2 className="text-4xl font-black text-[#18102B] tracking-tight mb-2 uppercase">Welcome Back</h2>
