  ...
  return (
    <div className="page-enter flex-1 flex flex-col min-h-screen bg-[#F5F3FF] overflow-hidden relative">
      ...
      <motion.div 
        ...
        className="absolute top-10 left-20 w-16 md:w-32 h-16 md:h-32 bg-[#FF6B35] border-2 md:border-4 border-[#18102B] rounded-full opacity-80 shadow-[8px_8px_0px_#18102B] pointer-events-none z-0"
      />
      <motion.div 
        animate={{ y: [0, 40, 0], rotate: [12, -10, 12] }}
        transition={{ repeat: Infinity, duration: 11, ease: "easeInOut" }}
        className="absolute bottom-10 right-20 w-40 h-40 bg-[#834DFB] border-2 md:border-4 border-[#18102B] opacity-80 rotate-12 shadow-[8px_8px_0px_#18102B] pointer-events-none z-0"
      />
      <motion.div 
        animate={{ x: [0, -20, 0], rotate: [45, 0, 45] }}
        transition={{ repeat: Infinity, duration: 13, ease: "easeInOut" }}
        className="absolute top-40 right-10 w-20 h-20 bg-[#C6FF3D] border-2 md:border-4 border-[#18102B] opacity-80 rotate-45 shadow-[6px_6px_0px_#18102B] pointer-events-none z-0"
      />
      ...
      <main className="flex-1 flex flex-col md:flex-row-reverse max-w-7xl mx-auto w-full z-10 relative">
        ...
        >
          <div className="w-20 h-20 bg-[#C6FF3D] border-2 md:border-4 border-black rounded-2xl flex items-center justify-center mb-4 md:mb-8 shadow-[6px_6px_0px_rgba(0,0,0,1)] rotate-3">
        ...
        >
          <TiltWrapper className="w-full max-w-md bg-white p-6 md:p-8 rounded-[32px] border-2 md:border-4 border-black shadow-[6px_6px_0px_rgba(0,0,0,1)] md:shadow-[12px_12px_0px_rgba(0,0,0,1)] relative z-20">
            ...
            <div className="mb-10 text-center">
              <h2 className="text-lg md:text-2xl md:text-4xl font-black text-[#18102B] tracking-tight mb-2 uppercase">Join Us</h2>
